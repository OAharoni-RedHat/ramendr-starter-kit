...
| [ramendr-hub-managed-connectivity.md](ramendr-hub-managed-connectivity.md) | All variants | Hub ↔ managed connectivity (mermaid for odf; [PNG](drpartner-s4-connectivity.png) / [PNG](drpartner-minimal-connectivity.png) for drpartner variants) |
